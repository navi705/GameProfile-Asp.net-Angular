...
namespace GameProfile.WebAPI.Controllers
{
    public class ProfileController : ApiController
    {
        ...
        public async Task<IActionResult> Profile()
        {
            ...
            var answer = new AnswerForProfile() { NickName = profile.Name.Value.ToString(), Description = profile.Description.Value.ToString(), Avatar = userCache.AvatarImage.ToString().Replace("_medium", "_full"), GameList = games };
            return Ok(answer);
        }
        ...
        public class AnswerForProfile
        {
            ...
            public List<GameForProfile> GameList { get; set; }
