...
namespace GameProfile.Persistence.Migrations
{
    ...
    [Migration("20231123053655_AddRanks")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameProfile.Domain.Entities.GameEntites.GameCommentHasReplie", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("GameCommentHasReplies");
                });

            modelBuilder.Entity("GameProfile.Domain.Entities.GameEntites.GameHasComments", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GameProfile.Domain.Entities.ProfileEntites.GameHasRatingFromProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("GameHasRatingFromProfiles");
                });
            ...
            modelBuilder.Entity("GameProfile.Domain.Entities.ProfileEntites.Ranks", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("RankImageMax")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("GameProfile.Domain.Entities.GameEntites.GameCommentHasReplie", b =>
                {
                    b.HasOne("GameProfile.Domain.Entities.GameEntites.GameHasComments", "GameHasComments")
                        .WithMany("GameCommentHasReplies")
            ...
            modelBuilder.Entity("GameProfile.Domain.Entities.ProfileEntites.GameHasRatingFromProfile", b =>
                {
                    b.HasOne("GameProfile.Domain.Entities.GameEntites.Game", "Game")
                        .WithMany("GameHasRatingFromProfiles")
                        .HasForeignKey("GameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GameProfile.Domain.Entities.ProfileEntites.Profile", b =>
                {
                    b.OwnsMany("GameProfile.Domain.ValueObjects.StringForEntity", "NotificationMessages", b1 =>
                        {
                            ...
                            b1.ToTable("Profiles_NotificationMessages");
            ...
            modelBuilder.Entity("GameProfile.Domain.Entities.GameEntites.Game", b =>
                {
                    ...
                    b.Navigation("GameHasRatingFromProfiles");
            ...
            modelBuilder.Entity("GameProfile.Domain.Entities.GameEntites.GameHasComments", b =>
                {
                    b.Navigation("GameCommentHasReplies");
                });
